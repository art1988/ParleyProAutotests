...
public class LoginToPopoversTenantAsMyTeamCN
{
    ...
    @Test(priority = 2)
    @Description("Under [My Team CN] user this test hovers over user icons and checks that MESSAGE button is present. Sends message and verify that email has been received.")
