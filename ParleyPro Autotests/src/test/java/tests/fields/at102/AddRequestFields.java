...
{
    private static Logger logger = Logger.getLogger(AddRequestFields.class);

    @Test
    public void addRequestFields() throws InterruptedException
    {
        ...
        contractFields.createNewFiled("Contract Request", "ff1", FieldType.SELECT, false);
        contractFields.addValues("ff1", "a");
        contractFields.addValues("ff1", "b");

        contractFields.createNewFiled("Contract Request", "ff2", FieldType.SELECT, false);
        contractFields.addValues("ff2", "c");
        contractFields.addValues("ff2", "d");

        contractFields.createNewFiled("Contract Request", "linked1", FieldType.SELECT, false);
        contractFields.addValues("linked1", "1");
        contractFields.addValues("linked1", "2");

        contractFields.createNewFiled("Contract Request", "linked2", FieldType.SELECT, false);
        ...
        logger.info("Perform drag&drop of linked2 and ff1 request fields...");
