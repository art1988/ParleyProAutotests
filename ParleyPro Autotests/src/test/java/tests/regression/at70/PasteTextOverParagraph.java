...
public class PasteTextOverParagraph
{
    ...
    public void PasteTextOverParagraph() throws InterruptedException
    {
        ...
        textFromItemTwo = textFromItemTwo.replaceAll("\u00a0",""); // remove all NBSP symbols
        textFromItemTwo = textFromItemTwo.replaceAll("\n",""); // remove all new line symbols
        Assert.assertEquals(textFromItemTwo, "2.p_Text1" + "P_Text2", "Looks like paragraphs weren't pasted !");
