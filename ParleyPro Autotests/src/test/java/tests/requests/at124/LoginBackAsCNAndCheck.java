...
public class LoginBackAsCNAndCheck
{
    ...
    public void loginBackAsCNAndCheck() throws InterruptedException
    {
        ...
        Assert.assertEquals($("#contractingRegion").val(), "region1", "[Summary field] Contracting region is wrong !!!");
        Assert.assertEquals($("#contractingCountry").val(), "country1", "[Summary field] Contracting country is wrong !!!");
        Assert.assertEquals($("#contractEntity").val(), "entity1", "[Summary field] Contract entity is wrong !!!");
        Assert.assertEquals($("#ContractingDepartment").val(), "department2", "[Summary field] Contracting department is wrong !!!");
        Assert.assertEquals($("#contractCategory").val(), "category2", "[Summary field] Contract category is wrong !!!");
