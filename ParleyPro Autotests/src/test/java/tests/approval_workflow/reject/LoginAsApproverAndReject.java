...
public class LoginAsApproverAndReject
{
    ...
    public void loginBackAsCN()
    {
        ...
        EmailChecker.assertEmailBySubject("imap.gmail.com", "arthur.khasanov@parleypro.com", "ParGd881",
                "Document \"pramata\" rejected by arthur.khasanov+approval1@parleypro.com");
    }
}
