...
public class Const
{
    ...
    public static final User   PREDEFINED_CCN2               = new User("P CCN AT 2 fn", "F CCN AT 2 ln", "arthur.khasanov+ccn_at2@parleypro.com", "Parley650!");
    ...
    public static final File   DOC_AT255_DOWNLOAD            = new File(System.getProperty("user.dir") + "/Documents/Yards Brewery Word Agreement.docx");
